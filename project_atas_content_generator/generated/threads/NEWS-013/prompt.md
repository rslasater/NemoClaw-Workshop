...

{
  "thread": {
    "thread_id": "NEWS-013",
    "purpose": "Navy and maritime headlines",
    "email_count": 2,
    "importance": "noise",
    "truth_ids": [],
    "planned_attachments": []
  ...
  "messages_to_author": [
    {
      "id": "NEWS-013-001",
      "thread_index": 1,
      "sent_at": "2026-09-30T06:55:00-04:00",
      "from": {
        "name": "USNI News Daily",
        "email": "daily@usni.example"
      },
      "to": [
        {
      ...
      "cc": [],
      "subject": "Fleet brief: maintenance delays and deployment schedule changes",
    ...
    },
    {
      "id": "NEWS-013-002",
      "thread_index": 2,
      "sent_at": "2026-10-04T07:42:00-04:00",
      "from": {
        "name": "USNI News Daily",
        "email": "daily@usni.example"
      },
      ...
      "cc": [],
      "subject": "Daily news: unmanned systems and maritime readiness",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": null,
