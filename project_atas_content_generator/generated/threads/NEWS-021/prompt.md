...

{
  "thread": {
    "thread_id": "NEWS-021",
    "purpose": "Nextgov and FCW technology updates",
    "email_count": 2,
    "importance": "noise",
    "truth_ids": [],
    "planned_attachments": []
  ...
  "messages_to_author": [
    {
      "id": "NEWS-021-001",
      "thread_index": 1,
      "sent_at": "2026-10-02T08:06:00-04:00",
      "from": {
        "name": "Nextgov/FCW Tech Update",
        "email": "techupdate@nextgov.example"
      },
      "to": [
        {
      ...
      "cc": [],
      "subject": "Cyber brief: identity pilots and software supply chain",
    ...
    },
    {
      "id": "NEWS-021-002",
      "thread_index": 2,
      "sent_at": "2026-10-05T12:48:00-04:00",
      "from": {
        "name": "Nextgov/FCW Tech Update",
        "email": "techupdate@nextgov.example"
      },
      ...
      "cc": [],
      "subject": "Tech update: data centers, cloud, and model governance",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": null,
