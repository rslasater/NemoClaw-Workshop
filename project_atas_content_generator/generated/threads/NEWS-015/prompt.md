...

{
  "thread": {
    "thread_id": "NEWS-015",
    "purpose": "Navy Times benefits and community updates",
    "email_count": 2,
    "importance": "noise",
    "truth_ids": [],
    "planned_attachments": []
  ...
  "messages_to_author": [
    {
      "id": "NEWS-015-001",
      "thread_index": 1,
      "sent_at": "2026-09-30T09:12:00-04:00",
      "from": {
        "name": "Navy Times Daily Headlines",
        "email": "headlines@navytimes.example"
      },
      "to": [
        {
      ...
      "cc": [],
      "subject": "Daily headlines: housing, orders, and retention changes",
    ...
    },
    {
      "id": "NEWS-015-002",
      "thread_index": 2,
      "sent_at": "2026-10-04T11:08:00-04:00",
      "from": {
        "name": "Navy Times Daily Headlines",
        "email": "headlines@navytimes.example"
      },
      ...
      "cc": [],
      "subject": "Benefits update: pay tables and family programs",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": null,
