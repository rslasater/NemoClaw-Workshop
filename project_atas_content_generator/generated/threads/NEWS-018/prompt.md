...

{
  "thread": {
    "thread_id": "NEWS-018",
    "purpose": "Technical learning recommendations",
    "email_count": 2,
    "importance": "noise",
    "truth_ids": [],
    "planned_attachments": []
  ...
  "messages_to_author": [
    {
      "id": "NEWS-018-001",
      "thread_index": 1,
      "sent_at": "2026-10-01T08:58:00-04:00",
      "from": {
        "name": "O'Reilly Learning",
        "email": "learning@oreilly.example"
      },
      "to": [
        {
      ...
      "cc": [],
      "subject": "Recommended: secure Python APIs and LLM evaluation",
    ...
    },
    {
      "id": "NEWS-018-002",
      "thread_index": 2,
      "sent_at": "2026-10-05T09:37:00-04:00",
      "from": {
        "name": "O'Reilly Learning",
        "email": "learning@oreilly.example"
      },
      ...
      "cc": [],
      "subject": "Your learning playlist: Kubernetes, FastAPI, and data tooling",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": null,
