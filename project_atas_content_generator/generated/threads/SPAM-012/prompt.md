...

{
  "thread": {
    "thread_id": "SPAM-012",
    "purpose": "Lowe's for Pros promotions",
    "email_count": 2,
    "importance": "noise",
    "truth_ids": [],
    "planned_attachments": []
  ...
  "messages_to_author": [
    {
      "id": "SPAM-012-001",
      "thread_index": 1,
      "sent_at": "2026-10-01T13:52:00-04:00",
      "from": {
        "name": "Lowe's for Pros",
        "email": "pros@lowes.example"
      },
      "to": [
        {
      ...
      "cc": [],
      "subject": "Pro savings on garage storage and tools",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": null,
      "purpose": "Lowes for Pros promotions",
      "facts_to_support": []
    },
    {
      "id": "SPAM-012-002",
      "thread_index": 2,
      "sent_at": "2026-10-04T17:54:00-04:00",
      "from": {
        "name": "Lowe's for Pros",
        "email": "pros@lowes.example"
      },
      ...
      "cc": [],
      "subject": "Weekend project deals near San Diego",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": null,
