...

{
  "thread": {
    "thread_id": "ATAS-002",
    "purpose": "Weekly engineering status",
    "email_count": 8,
    "importance": "medium",
    "truth_ids": [
      "T-001"
  ...
  "messages_to_author": [
    {
      "id": "ATAS-002-001",
      "thread_index": 1,
      "sent_at": "2026-09-29T09:51:00.937972-04:00",
      "from": {
      ...
      "subject": "Weekly engineering status",
    ...
    },
    {
      "id": "ATAS-002-002",
      "thread_index": 2,
      "sent_at": "2026-09-30T15:18:00.737940-04:00",
      "from": {
        "name": "Rebecca Shaw",
        "email": "rebecca.shaw@aegis-technologies.example"
      },
      ...
      "cc": [],
      "subject": "RE: Weekly engineering status",
      "classification": "UNCLASSIFIED",
      "importance": "medium",
      "attachments": [],
      "in_reply_to": "ATAS-002-001",
      "purpose": "Weekly engineering status",
      "facts_to_support": [
        "T-001"
      ]
    },
    {
      "id": "ATAS-002-003",
      "thread_index": 3,
      "sent_at": "2026-10-01T14:56:00.652405-04:00",
      "from": {
        "name": "LCDR James Maddox",
        "email": "james.maddox@jiaitf.example"
      },
      ...
      "cc": [],
      "subject": "Training run status",
      "classification": "UNCLASSIFIED",
      "importance": "medium",
      "attachments": [],
      "in_reply_to": "ATAS-002-002",
      "purpose": "Weekly engineering status",
      "facts_to_support": [
        "T-001"
      ]
    },
    {
      "id": "ATAS-002-004",
      "thread_index": 4,
      "sent_at": "2026-10-01T20:51:00.220182-04:00",
      "from": {
        "name": "COL Jesse Abreu",
        "email": "jesse.abreu@jiaitf.example"
      },
      ...
      "subject": "GPU utilization update",
      "classification": "UNCLASSIFIED",
      "importance": "medium",
      "attachments": [],
      "in_reply_to": "ATAS-002-003",
      "purpose": "Weekly engineering status",
      "facts_to_support": [
        "T-001"
      ]
    },
    {
      "id": "ATAS-002-005",
      "thread_index": 5,
      "sent_at": "2026-10-02T22:03:00.325742-04:00",
      "from": {
        "name": "Dr. Josh Brunner",
        "email": "josh.brunner@aegis-technologies.example"
      },
      ...
      "cc": [],
      "subject": "Model convergence notes",
      "classification": "UNCLASSIFIED",
      "importance": "medium",
      "attachments": [],
      "in_reply_to": "ATAS-002-004",
      "purpose": "Weekly engineering status",
      "facts_to_support": [
        "T-001"
      ]
    },
    {
      "id": "ATAS-002-006",
      "thread_index": 6,
      "sent_at": "2026-10-03T08:38:00.762114-04:00",
      "from": {
        "name": "Rebecca Shaw",
        "email": "rebecca.shaw@aegis-technologies.example"
      },
      ...
      "cc": [],
      "subject": "Software integration status",
      "classification": "UNCLASSIFIED",
      "importance": "medium",
      "attachments": [],
      "in_reply_to": "ATAS-002-005",
      "purpose": "Weekly engineering status",
      "facts_to_support": [
        "T-001"
      ]
    },
    {
      "id": "ATAS-002-007",
      "thread_index": 7,
      "sent_at": "2026-10-04T08:18:00.474076-04:00",
      "from": {
        "name": "LCDR James Maddox",
        "email": "james.maddox@jiaitf.example"
      },
      ...
      "subject": "RE: Software integration status",
      "classification": "UNCLASSIFIED",
      "importance": "medium",
      "attachments": [],
      "in_reply_to": "ATAS-002-006",
      "purpose": "Weekly engineering status",
      "facts_to_support": [
        "T-001"
      ]
    },
    {
      ...
      "cc": [],
      "subject": "Friday closeout",
      "classification": "UNCLASSIFIED",
      "importance": "medium",
      "attachments": [],
      "in_reply_to": "ATAS-002-007",
      "purpose": "Weekly engineering status",
      "facts_to_support": [
        "T-001"
      ]
