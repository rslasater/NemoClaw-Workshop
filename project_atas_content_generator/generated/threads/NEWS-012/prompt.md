...

{
  "thread": {
    "thread_id": "NEWS-012",
    "purpose": "Federal workforce and IT news",
    "email_count": 2,
    "importance": "noise",
    "truth_ids": [],
    "planned_attachments": []
  ...
  "messages_to_author": [
    {
      "id": "NEWS-012-001",
      "thread_index": 1,
      "sent_at": "2026-09-29T09:04:00-04:00",
      "from": {
        "name": "Federal News Network",
        "email": "updates@federalnewsnetwork.example"
      },
      "to": [
        {
      ...
      "cc": [],
      "subject": "Workforce update: PCS policy, hiring timelines, and telework notes",
    ...
    },
    {
      "id": "NEWS-012-002",
      "thread_index": 2,
      "sent_at": "2026-10-03T10:39:00-04:00",
      "from": {
        "name": "Federal News Network",
        "email": "updates@federalnewsnetwork.example"
      },
      ...
      "cc": [],
      "subject": "Agency IT update: zero trust reporting and cloud spending",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": null,
