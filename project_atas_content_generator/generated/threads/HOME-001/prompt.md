...

{
  "thread": {
    "thread_id": "HOME-001",
    "purpose": "San Diego realtor listings",
    "email_count": 7,
    "importance": "noise",
    "truth_ids": [
      "T-016",
  ...
  "messages_to_author": [
    {
      "id": "HOME-001-001",
      "thread_index": 1,
      "sent_at": "2026-09-29T16:38:00-04:00",
      "from": {
        "name": "Emily Maddox",
      ...
      "subject": "New San Diego listings",
    ...
    },
    {
      "id": "HOME-001-002",
      "thread_index": 2,
      "sent_at": "2026-10-01T07:07:00-04:00",
      "from": {
        "name": "Megan Ortiz",
        "email": "megan@coastalkeyrealty.example"
      },
      ...
      "cc": [],
      "subject": "RE: New San Diego listings",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": "HOME-001-001",
      "purpose": "San Diego realtor listings",
      "facts_to_support": [
        "T-016",
        "T-018"
    ...
    },
    {
      "id": "HOME-001-003",
      "thread_index": 3,
      "sent_at": "2026-10-01T20:31:00-04:00",
      "from": {
        "name": "Daniel Cho",
        "email": "daniel.cho@harborviewlending.example"
      },
      ...
      "cc": [],
      "subject": "Point Loma option",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": "HOME-001-002",
      "purpose": "San Diego realtor listings",
      "facts_to_support": [
        "T-016",
        "T-018"
    ...
    },
    {
      "id": "HOME-001-004",
      "thread_index": 4,
      "sent_at": "2026-10-02T10:03:00-04:00",
      "from": {
        "name": "LCDR James Maddox",
        "email": "james.maddox@jiaitf.example"
      },
      ...
      "subject": "Clairemont option",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": "HOME-001-003",
      "purpose": "San Diego realtor listings",
      "facts_to_support": [
        "T-016",
        "T-018"
    ...
    },
    {
      "id": "HOME-001-005",
      "thread_index": 5,
      "sent_at": "2026-10-03T15:38:00-04:00",
      "from": {
        "name": "Emily Maddox",
        "email": "emily.maddox@example.com"
      },
      ...
      "cc": [],
      "subject": "Open house schedule",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": "HOME-001-004",
      "purpose": "San Diego realtor listings",
      "facts_to_support": [
        "T-016",
        "T-018"
    ...
    },
    {
      "id": "HOME-001-006",
      "thread_index": 6,
      "sent_at": "2026-10-03T22:51:00-04:00",
      "from": {
        "name": "Megan Ortiz",
        "email": "megan@coastalkeyrealty.example"
      },
    ...
    },
    {
      "id": "HOME-001-007",
      "thread_index": 7,
      "sent_at": "2026-10-04T10:12:00-04:00",
      "from": {
        "name": "Daniel Cho",
        "email": "daniel.cho@harborviewlending.example"
      },
      ...
      "subject": "Weekend listing recap",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": "HOME-001-006",
      "purpose": "San Diego realtor listings",
      "facts_to_support": [
        "T-016",
        "T-018"
