...

{
  "thread": {
    "thread_id": "NEWS-019",
    "purpose": "Engineering job search notifications",
    "email_count": 2,
    "importance": "noise",
    "truth_ids": [],
    "planned_attachments": []
  ...
  "messages_to_author": [
    {
      "id": "NEWS-019-001",
      "thread_index": 1,
      "sent_at": "2026-10-01T10:11:00-04:00",
      "from": {
        "name": "Stack Overflow Talent",
        "email": "saved-searches@stackoverflow.example"
      },
      "to": [
        {
      ...
      "cc": [],
      "subject": "Saved search: AI platform and systems roles",
    ...
    },
    {
      "id": "NEWS-019-002",
      "thread_index": 2,
      "sent_at": "2026-10-05T14:05:00-04:00",
      "from": {
        "name": "Stack Overflow Talent",
        "email": "saved-searches@stackoverflow.example"
      },
      ...
      "cc": [],
      "subject": "New matches for Python backend and ML infrastructure",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": null,
