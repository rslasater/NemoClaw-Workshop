...

{
  "thread": {
    "thread_id": "NEWS-022",
    "purpose": "Google Cloud public sector updates",
    "email_count": 2,
    "importance": "noise",
    "truth_ids": [],
    "planned_attachments": []
  ...
  "messages_to_author": [
    {
      "id": "NEWS-022-001",
      "thread_index": 1,
      "sent_at": "2026-10-02T09:51:00-04:00",
      "from": {
        "name": "Google Cloud Public Sector",
        "email": "public-sector@googlecloud.example"
      },
      "to": [
        {
      ...
      "cc": [],
      "subject": "Public sector update: AI agents and security controls",
    ...
    },
    {
      "id": "NEWS-022-002",
      "thread_index": 2,
      "sent_at": "2026-10-05T15:29:00-04:00",
      "from": {
        "name": "Google Cloud Public Sector",
        "email": "public-sector@googlecloud.example"
      },
      ...
      "cc": [],
      "subject": "Webinar reminder: secure analytics for mission teams",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": null,
