...

{
  "thread": {
    "thread_id": "NEWS-023",
    "purpose": "Red Hat government open source bulletin",
    "email_count": 2,
    "importance": "noise",
    "truth_ids": [],
    "planned_attachments": []
  ...
  "messages_to_author": [
    {
      "id": "NEWS-023-001",
      "thread_index": 1,
      "sent_at": "2026-10-02T10:34:00-04:00",
      "from": {
        "name": "Red Hat Government",
        "email": "government@redhat.example"
      },
      "to": [
        {
      ...
      "cc": [],
      "subject": "Open source briefing: edge compute and automation",
    ...
    },
    {
      "id": "NEWS-023-002",
      "thread_index": 2,
      "sent_at": "2026-10-04T12:19:00-04:00",
      "from": {
        "name": "Red Hat Government",
        "email": "government@redhat.example"
      },
      ...
      "cc": [],
      "subject": "Event reminder: Ansible for regulated environments",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": null,
