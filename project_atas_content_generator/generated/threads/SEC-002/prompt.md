...

{
  "thread": {
    "thread_id": "SEC-002",
    "purpose": "Career discussion with Stix",
    "email_count": 5,
    "importance": "low",
    "truth_ids": [
      "T-016"
  ...
  "messages_to_author": [
    {
      "id": "SEC-002-001",
      "thread_index": 1,
      "sent_at": "2026-09-30T10:12:00.688156-04:00",
      "from": {
    ...
    },
    {
      "id": "SEC-002-002",
      "thread_index": 2,
      "sent_at": "2026-10-01T15:38:00.346723-04:00",
      "from": {
        "name": "LCDR James Maddox",
        "email": "james.maddox@jiaitf.example"
      },
      ...
      "cc": [],
      "subject": "RE: Rotation rumors",
      "classification": "UNCLASSIFIED",
      "importance": "low",
      "attachments": [],
      "in_reply_to": "SEC-002-001",
      "purpose": "Career discussion with Stix",
      "facts_to_support": [
        "T-016"
      ]
    },
    {
      "id": "SEC-002-003",
      "thread_index": 3,
      "sent_at": "2026-10-02T08:07:00.169328-04:00",
      "from": {
        "name": "JIAITF Security Office",
        "email": "security@jiaitf.example"
      },
      ...
      "cc": [],
      "subject": "San Diego orders?",
      "classification": "UNCLASSIFIED",
      "importance": "low",
      "attachments": [],
      "in_reply_to": "SEC-002-002",
      "purpose": "Career discussion with Stix",
      "facts_to_support": [
        "T-016"
      ]
    },
    {
      "id": "SEC-002-004",
      "thread_index": 4,
      "sent_at": "2026-10-04T20:12:00.178304-04:00",
      "from": {
        "name": "LCDR Jeff \"Stix\" Martinez",
        "email": "jeff.martinez@navy.example"
      },
    ...
    },
    {
      "id": "SEC-002-005",
      "thread_index": 5,
      "sent_at": "2026-10-04T22:31:00.065767-04:00",
      "from": {
        "name": "LCDR James Maddox",
        "email": "james.maddox@jiaitf.example"
      },
      ...
      "cc": [],
      "subject": "RE: Career options",
      "classification": "UNCLASSIFIED",
      "importance": "low",
      "attachments": [],
      "in_reply_to": "SEC-002-004",
      "purpose": "Career discussion with Stix",
      "facts_to_support": [
        "T-016"
      ]
