...

{
  "thread": {
    "thread_id": "NEWS-011",
    "purpose": "Acquisition Today briefings",
    "email_count": 2,
    "importance": "noise",
    "truth_ids": [],
    "planned_attachments": []
  ...
  "messages_to_author": [
    {
      "id": "NEWS-011-001",
      "thread_index": 1,
      "sent_at": "2026-09-29T08:12:00-04:00",
      "from": {
        "name": "Acquisition Today",
        "email": "briefing@acquisitiontoday.example"
      },
      "to": [
        {
      ...
      "cc": [],
      "subject": "Morning memo: rapid acquisition and test range modernization",
    ...
    },
    {
      "id": "NEWS-011-002",
      "thread_index": 2,
      "sent_at": "2026-10-02T14:47:00-04:00",
      "from": {
        "name": "Acquisition Today",
        "email": "briefing@acquisitiontoday.example"
      },
      ...
      "cc": [],
      "subject": "Afternoon update: OTA activity and budget marks",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": null,
