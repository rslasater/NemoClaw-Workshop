...

{
  "thread": {
    "thread_id": "HOME-004",
    "purpose": "School and commute research",
    "email_count": 5,
    "importance": "noise",
    "truth_ids": [
      "T-018"
  ...
  "messages_to_author": [
    {
      "id": "HOME-004-001",
      "thread_index": 1,
      "sent_at": "2026-10-01T13:24:00-04:00",
      "from": {
        "name": "Emily Maddox",
      ...
      "subject": "School district comparison",
    ...
    },
    {
      "id": "HOME-004-002",
      "thread_index": 2,
      "sent_at": "2026-10-01T17:38:00-04:00",
      "from": {
        "name": "Megan Ortiz",
        "email": "megan@coastalkeyrealty.example"
      },
      ...
      "cc": [],
      "subject": "Commute from Point Loma",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": "HOME-004-001",
      "purpose": "School and commute research",
      "facts_to_support": [
        "T-018"
      ]
    },
    {
      "id": "HOME-004-003",
      "thread_index": 3,
      "sent_at": "2026-10-02T08:18:00-04:00",
      "from": {
        "name": "Daniel Cho",
        "email": "daniel.cho@harborviewlending.example"
      },
      ...
      "cc": [],
      "subject": "RE: Commute from Point Loma",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": "HOME-004-002",
      "purpose": "School and commute research",
      "facts_to_support": [
        "T-018"
      ]
    },
    {
      "id": "HOME-004-004",
      "thread_index": 4,
      "sent_at": "2026-10-03T16:24:00-04:00",
      "from": {
        "name": "LCDR James Maddox",
        "email": "james.maddox@jiaitf.example"
      },
      ...
      "subject": "After-school options",
      "classification": "UNCLASSIFIED",
      "importance": "noise",
      "attachments": [],
      "in_reply_to": "HOME-004-003",
      "purpose": "School and commute research",
      "facts_to_support": [
        "T-018"
      ]
    },
    {
      "id": "HOME-004-005",
      "thread_index": 5,
      "sent_at": "2026-10-03T20:12:00-04:00",
      "from": {
        "name": "Emily Maddox",
        "email": "emily.maddox@example.com"
      },
